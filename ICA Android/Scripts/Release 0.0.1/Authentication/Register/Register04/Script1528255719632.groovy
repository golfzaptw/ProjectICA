...
Mobile.setText(findTestObject('Register/edt/edtPass'), '12', 0)
...
Mobile.scrollToText('Ihr Passwort muss zwischen 8 und 30 Zeichen lang sein', FailureHandling.STOP_ON_FAILURE)
