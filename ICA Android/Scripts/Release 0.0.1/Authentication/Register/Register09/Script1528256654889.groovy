...
Mobile.verifyElementNotVisible(findTestObject('Register/txt/txt Ihre E-Mail besttigen'), 0)

Mobile.verifyElementNotVisible(findTestObject('Register/txt/txt Resendmail'), 0)
