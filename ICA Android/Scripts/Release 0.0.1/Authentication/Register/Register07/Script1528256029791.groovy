...
def email = FileCode.randomString() + '@gmail.com'

Mobile.setText(findTestObject('Register/edt/edtEmail'), email, 0)
...
Mobile.waitForElementPresent(findTestObject('LoadingStage'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.waitForElementPresent(findTestObject('Register/txt/txt TERMS AND CONDITIONS'), 0)

Mobile.scrollToText('Institute of Culinary Art terms and conditions', FailureHandling.STOP_ON_FAILURE)

Mobile.waitForElementPresent(findTestObject('Register/checkbox/checkbox Ich stimmen den AGBs und Datenschutzbestimmungen zu'), 
    0)

Mobile.tap(findTestObject('Register/checkbox/checkbox Ich stimmen den AGBs und Datenschutzbestimmungen zu'), 0)

Mobile.waitForElementPresent(findTestObject('Register/btn/btn ConfirmRegister'), 0)

Mobile.tap(findTestObject('Register/btn/btn ConfirmRegister'), 0)

Mobile.waitForElementPresent(findTestObject('Register/txt/txt Ihre E-Mail besttigen'), 0)

Mobile.waitForElementPresent(findTestObject('Register/txt/txt Resendmail'), 0)

Mobile.waitForElementPresent(findTestObject('Register/btn/btn Back to login'), 0)

Mobile.tap(findTestObject('Register/btn/btn Back to login'), 0)
...
Mobile.scrollToText('email ist schon vergeben', FailureHandling.STOP_ON_FAILURE)
