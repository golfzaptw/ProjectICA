...
def email = FileCode.randomString()

Mobile.setText(findTestObject('Login/edt/edtEmail'), email + '@gmail.com', 0)

Mobile.waitForElementPresent(findTestObject('Login/txt/txt Passwort'), 0)

Mobile.setText(findTestObject('Login/edt/edtPassword'), email, 0)
...
Mobile.scrollToText('E-Mail oder Passwort ungültig', FailureHandling.STOP_ON_FAILURE)
