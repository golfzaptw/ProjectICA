...
Mobile.setText(findTestObject('Changepassword/edt/edt OldPass'), '', 0)

Mobile.waitForElementPresent(findTestObject('Changepassword/txt/txt NewPass'), 0)

Mobile.setText(findTestObject('Changepassword/edt/edt NewPass'), '', 0)

Mobile.waitForElementPresent(findTestObject('Changepassword/txt/txt ReNewPass'), 0)

Mobile.setText(findTestObject('Changepassword/edt/edt ReNewPass'), '', 0)
...
val = Mobile.getText(findTestObject('Changepassword/edt/edt OldPass'), 0, FailureHandling.STOP_ON_FAILURE)

Mobile.waitForElementPresent(findTestObject('Changepassword/txt/txt NewPass'), 0)

val = Mobile.getText(findTestObject('Changepassword/edt/edt NewPass'), 0, FailureHandling.STOP_ON_FAILURE)

Mobile.waitForElementPresent(findTestObject('Changepassword/txt/txt ReNewPass'), 0)

val = Mobile.getText(findTestObject('Changepassword/edt/edt ReNewPass'), 0, FailureHandling.STOP_ON_FAILURE)
