...
Mobile.setText(findTestObject('Changepassword/edt/edt OldPass'), '1231231231', 0)
...
Mobile.scrollToText('das passwort ist ungültig', FailureHandling.STOP_ON_FAILURE)
