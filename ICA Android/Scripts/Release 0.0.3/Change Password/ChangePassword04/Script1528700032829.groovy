...
Mobile.setText(findTestObject('Changepassword/edt/edt ReNewPass'), '121212121', 0)
...
Mobile.scrollToText('Ihre Passwörter stimmen nicht überein', FailureHandling.STOP_ON_FAILURE)
