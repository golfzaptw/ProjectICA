...
Mobile.setText(findTestObject('ForgotPass/edt Email'), 'psgolf11@gmail.com', 0)
...
Mobile.waitForElementPresent(findTestObject('ForgotPass/txt/txt Vielen Dank'), 0)

Mobile.waitForElementPresent(findTestObject('ForgotPass/txt/txt Folgen Sie bitte dem Link in Ihrer E-Mail um Ihr Passwort zurckzusetzen. Nach dem Zurcksetzen knnen Sie sich wieder einloggen'),
	0)

Mobile.tap(findTestObject('ForgotPass/btn/btn ZURCK ZUR LOGIN-SEITE'), 0)
